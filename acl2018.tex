...
In this way, an agent can choose the best response according to the 
specific user preference 
%\cite{}
and use appropriate speech style based on profile or attributes of who 
it is interacting with 
\cite{Joshi2017PersonalizationIG}.

A first and prominent attempt to model persona was by \newcite{li2016persona} 
where the authors proposed to assign specific conversation style to agents
based on learned persona embedding. 
