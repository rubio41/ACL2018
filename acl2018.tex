...
A first attempt to model persona is from \newcite{li-EtAl:2016:P16-13}, who propose to assign specific personality and conversation style to agents based on learned persona embeddings.
Recently, \newcite{DBLP:journals/corr/abs-1710-07388} describe an interesting approach in the use of multi-task learning with personalized text data.
%\newcite{ficler-goldberg:2017:StyVa} perform a conditional language model to generate text with stylistic restrictions.
\newcite{Qian2017AssigningPT} give the system an identity with profile in order to enhance the response consistency.
Other researchers have recently attempted to introduce personalized information to dialog systems by transfer learning \cite{Yang:2017:PRG:3077136.3080706, DBLP:journals/corr/ZhangLWZ17}.
...
Instead of assigning a personality to agents \cite{li-EtAl:2016:P16-13, DBLP:journals/corr/abs-1710-07388, Qian2017AssigningPT}, our model pays more attention on the user persona and aim to make agents more adaptive to different kinds of users.
...
As most of the previous works \cite{li-EtAl:2016:P16-13, DBLP:journals/corr/abs-1710-07388, Qian2017AssigningPT} focus on chit-chat, the combination of personalization and goal-oriented dialog remains to be explored.
Our work mainly focuses on goal-oriented dialog, 
